...
<div class="container-fluid py-4">
    <div class="row g-4 mb-4">
        ...
        $traites = $dossiers->where('statut', 'Cloture')->count();
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card shadow-sm border-0 h-100">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        <div class="text-uppercase small fw-bold text-muted">Clotures</div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card shadow-sm border-0 h-100">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        <div class="text-uppercase small fw-bold text-muted">Archives</div>
    ...
    @include('partials.dossier_search', ['route' => 'dossiers.index.procureur', 'statuts' => $statuts])
