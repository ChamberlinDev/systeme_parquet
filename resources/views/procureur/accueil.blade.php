...
<div class="row mb-3">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card h-100">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-uppercase mb-1">Decisions</div>
    ...
    <div class="col-xl-8 col-lg-7 mb-4">
        <div class="card">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <a class="m-0 float-right btn btn-danger btn-sm" href="{{ route('dossiers.index.procureur') }}">
                ...
                <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a href="{{ route('dossiers.index.procureur') }}" class="btn btn-sm btn-primary">Voir</a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
    ...
    <div class="col-xl-4 col-lg-5 mb-4">
        <div class="card mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Statistiques detaillees</h6>
            </div>
            <div class="card-body">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <div class="small text-gray-500">Dossiers traites
