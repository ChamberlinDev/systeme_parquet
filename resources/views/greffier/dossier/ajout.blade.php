            ...
            <div class="card-body p-5 text-dark">
                ...
                <form action="{{ route('dossiers.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-4 mb-4">
                        ...
                        <div class="col-md-6">
                            <label>Numéro Registre  <small class="text-muted">(genere automatiquement)</small></label>
                            <input type="text" class="form-control bg-light" name="numero_rp"
                                value="{{ $numbers['numero_rp'] }}" readonly>
                        </div>

                        <div class="col-md-6">
                            <label>Numéro dossier <small class="text-muted">(generer automatiquement)</small></label>
                    ...
                    <!-- Fichiers PDF -->
                    <h5 class="text-dark">Pièces jointes</h5>
...
<script>
    ...
    // Mise à jour du numéro registre selon le type
    document.getElementById('typeAffaire').addEventListener('change', function() {
        ...
        const rp = document.querySelector('[name="numero_rp"]').value; // RP/2026/001
